...
public enum SelectionQueries implements Query {
    ...
    BOOK_DETAILS("SELECT ?label ?value WHERE { ?book rdf:type <https://www.cs.unicam.it/matteo.machella/sci-fi-ontology.rdf#sfo:Book> . FILTER(?book = <https://www.cs.unicam.it/matteo.machella/sci-fi-ontology.rdf#%s>) . ?book ?label ?value . }"),
